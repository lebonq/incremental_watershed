...
for i in range(0, len(names)):
    ...
    for set in range(nb_batch):
        file = open(name + "/" + name + "_liver_markers/markers_object_" + str(set) + ".txt", "w")
        for id in range(nb_marker):
    ...
    for set in range(nb_batch):
        file = open( name + "/" + name + "_liver_markers/markers_background_" + str(set) + ".txt", "w")
        for id in range(nb_marker):
